...
<div class="container" style="padding-top: 8.5rem;">
  <div class="conteainer-fluid d-md-flex">
    <div class="col-md-3 d-flex align-items-center justify-content-center rounded-2" style="width: 500px; height: 500px; overflow-y: hidden; background-color: rgb(0, 0, 0, 0.3);">
      <img src="/dist/img/<?= $komik['cover'] ?>" class="img-preview" alt="" height="500px" style="object-fit: cover;">
    </div>
    <div class="col-md-7 ms-md-3 mt-3" style="padding-bottom: 2rem;">
      <h1 class="fw-semibold">Edit Data Komik <ion-icon name="book-outline"></ion-icon>
      </h1>
      <hr>
      <form action="/admin/update/<?= $komik['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control <?=($validation->hasError('sinopsis')) ? 'is-invalid' : '' ?>" name="sinopsis" id="sinopsis" cols="30" rows="10"><?= (old('sinopsis')) ? old('sinopsis') : $komik['sinopsis'] ?></textarea>
          <div id="validationServer03Feedback" class="invalid-feedback">
        ...
        <div class="col-5 mb-3">
          ...
          <input type="number" class="form-control <?=($validation->hasError('harga')) ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= (old('harga')) ? old('harga') : $komik['harga'] ?>">
          <div id="validationServer03Feedback" class="invalid-feedback">
